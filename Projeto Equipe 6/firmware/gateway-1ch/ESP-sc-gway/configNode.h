...
//
wpas wpa[] = {
	{ "SEU-SSID",          "SUA-SENHA" },     // REDIGIDO: ver README
};
...
// Estes campos sobem no pacote de status (PUSH_DATA) e aparecem na ficha do
// gateway no ChirpStack. Estavam com os valores do autor original do projeto
// (Maarten Westenberg, Holanda) — trocados pelos nossos.
//
// O Gateway EUI nao se define aqui: e montado em runtime a partir do MAC da
// placa, em _udpSemtech.ino. Ver comentario no topo de configGway.h.
#define _DESCRIPTION "EdgeVision GW1"		// Name of the gateway
#define _EMAIL "owner123@gmail.com"		// Owner
#define _PLATFORM "ESP32"					// Heltec WiFi LoRa 32 V2
// Aproximado (Sorocaba/SP). Ajustar para o ponto real de instalacao — so afeta
// o pino no mapa do ChirpStack, nao o funcionamento do radio.
#define _LAT -23.50
#define _LON -47.45
#define _ALT 600							// Altitude
