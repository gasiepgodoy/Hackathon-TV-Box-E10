...
#	include <ESPmDNS.h>
#	include <SPIFFS.h>
	// O include precisa respeitar _WIFIMANAGER. Sem a guarda a biblioteca era
	// compilada mesmo desligada, e quebra no core ESP32 2.x (a assinatura de
	// WiFi.onEvent mudou). Com as credenciais fixas em wpa[], o portal de
	// configuracao e desnecessario.
#	if _WIFIMANAGER==1
