        ...
        while not stop.is_set():
            ...
            if prev is not None:
                ...
                if score > thresh and now - last > COOLDOWN:
                    ...
                    anotar(path, "m", now)
                    # Publica sempre. Quem quer ser avisado e escolha de cada
                    # celular, e mora no servidor (push_tokens.notify): aqui a
                    # box nao sabe de quem e o telefone, e a preferencia global
                    # que morava neste arquivo silenciava todo mundo de uma vez.
